...
3.5 [Summarizing the pedigree](#3.5)
...
### 3.5 Summarizing the pedigree {#3.5}
The `summary()` method provides a quick overview of the pedigree statistics, including the number of individuals, sex distribution, founders, and isolated individuals.
